    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className='add-product-name flex-col'>
          <p>Add the product name</p>
          <input onChange={onChangeHandler} value={data.name} type='text' name='name' placeholder='enter name'></input>
        </div>
        ...
        <div className="add-category-price">
          ...
          <div className="add-price flex-col">
            <p>Product price</p>
            <input onChange={onChangeHandler} value={data.price} type='Number' name='price' placeholder='Enter price'></input>
          </div>
        </div>
